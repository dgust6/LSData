...
open class PublisherModifyingDataSource<Output, OutputError: Error, DS: DataSource>: DataSource {
...
public extension DataSource {
    ...
    func modifyPublisher<NewOutput, NewOutputError: Error>(modifier: @escaping (AnyPublisher<Output, OutputError>) -> AnyPublisher<NewOutput, NewOutputError>) -> PublisherModifyingDataSource<NewOutput, NewOutputError,Self> {
        PublisherModifyingDataSource(dataSource: self, modifier: modifier)
    }
}
